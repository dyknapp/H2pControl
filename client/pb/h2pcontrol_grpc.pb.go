...
const (
	...
	Manager_UnregisterServer_FullMethodName    = "/h2pcontrol.Manager/UnregisterServer"
...
type ManagerClient interface {
	...
	UnregisterServer(ctx context.Context, in *UnregisterServerRequest, opts ...grpc.CallOption) (*Empty, error)
...
func (c *managerClient) UnregisterServer(ctx context.Context, in *UnregisterServerRequest, opts ...grpc.CallOption) (*Empty, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(Empty)
	err := c.cc.Invoke(ctx, Manager_UnregisterServer_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type ManagerServer interface {
	...
	UnregisterServer(context.Context, *UnregisterServerRequest) (*Empty, error)
...
func (UnimplementedManagerServer) GetStub(context.Context, *StubRequest) (*StubResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method GetStub not implemented")
}
...
func (UnimplementedManagerServer) UnregisterServer(context.Context, *UnregisterServerRequest) (*Empty, error) {
	return nil, status.Error(codes.Unimplemented, "method UnregisterServer not implemented")
}
...
func (UnimplementedManagerServer) FetchServers(context.Context, *Empty) (*FetchServersResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method FetchServers not implemented")
}
func (UnimplementedManagerServer) FetchSpecificServer(context.Context, *FetchSpecificServerRequest) (*FetchSpecificServerResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method FetchSpecificServer not implemented")
}
...
func _Manager_UnregisterServer_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(UnregisterServerRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ManagerServer).UnregisterServer(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Manager_UnregisterServer_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ManagerServer).UnregisterServer(ctx, req.(*UnregisterServerRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var Manager_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _Manager_UnregisterServer_Handler,
		},
		{

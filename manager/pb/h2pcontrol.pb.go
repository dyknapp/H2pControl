...
func (x *HeartbeatPing) GetRegistrationId() string {
	if x != nil {
...
type ServerDefinition struct {
	...
	AdvertisedHost string                 `protobuf:"bytes,2,opt,name=advertised_host,json=advertisedHost,proto3" json:"advertised_host,omitempty"`
...
func (x *ServerDefinition) GetAdvertisedHost() string {
	if x != nil {
...
func (x *UnregisterServerRequest) GetRegistrationId() string {
	if x != nil {
		return x.RegistrationId
	}
	return ""
...
func (x *File) Reset() {
	*x = File{}
	mi := &file_h2pcontrol_proto_msgTypes[13]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*File) Descriptor() ([]byte, []int) {
	return file_h2pcontrol_proto_rawDescGZIP(), []int{13}
}
...
const file_h2pcontrol_proto_rawDesc = "" +
	...
	"\x05Empty\"V\n" +
	"\rHeartbeatPing\x12'\n" +
	"\x0fregistration_id\x18\x01 \x01(\tR\x0eregistrationId\x12\x1c\n" +
	...
	"serverName\x12'\n" +
	"\x0fadvertised_host\x18\x02 \x01(\tR\x0eadvertisedHost\x12\x12\n" +
	...
	"\x0eRegisterServer\x12\x1b.h2pcontrol.RegisterRequest\x1a\x1c.h2pcontrol.RegisterResponse\x12J\n" +
	"\x10UnregisterServer\x12#.h2pcontrol.UnregisterServerRequest\x1a\x11.h2pcontrol.Empty\x12E\n" +
...
var file_h2pcontrol_proto_msgTypes = make([]protoimpl.MessageInfo, 14)
var file_h2pcontrol_proto_goTypes = []any{
	...
	(*UnregisterServerRequest)(nil),     // 6: h2pcontrol.UnregisterServerRequest
	(*FetchServerDefinition)(nil),       // 7: h2pcontrol.FetchServerDefinition
	(*FetchServersResponse)(nil),        // 8: h2pcontrol.FetchServersResponse
	(*FetchSpecificServerRequest)(nil),  // 9: h2pcontrol.FetchSpecificServerRequest
	(*FetchSpecificServerResponse)(nil), // 10: h2pcontrol.FetchSpecificServerResponse
	(*StubRequest)(nil),                 // 11: h2pcontrol.StubRequest
	(*StubResponse)(nil),                // 12: h2pcontrol.StubResponse
	(*File)(nil),                        // 13: h2pcontrol.File
}
var file_h2pcontrol_proto_depIdxs = []int32{
	13, // 0: h2pcontrol.ServerDefinition.proto_files:type_name -> h2pcontrol.File
	3,  // 1: h2pcontrol.RegisterRequest.server:type_name -> h2pcontrol.ServerDefinition
	7,  // 2: h2pcontrol.FetchServersResponse.servers:type_name -> h2pcontrol.FetchServerDefinition
	7,  // 3: h2pcontrol.FetchSpecificServerResponse.server_definition:type_name -> h2pcontrol.FetchServerDefinition
	11, // 4: h2pcontrol.Manager.GetStub:input_type -> h2pcontrol.StubRequest
	4,  // 5: h2pcontrol.Manager.RegisterServer:input_type -> h2pcontrol.RegisterRequest
	6,  // 6: h2pcontrol.Manager.UnregisterServer:input_type -> h2pcontrol.UnregisterServerRequest
	1,  // 7: h2pcontrol.Manager.Heartbeat:input_type -> h2pcontrol.HeartbeatPing
	0,  // 8: h2pcontrol.Manager.FetchServers:input_type -> h2pcontrol.Empty
	9,  // 9: h2pcontrol.Manager.FetchSpecificServer:input_type -> h2pcontrol.FetchSpecificServerRequest
	12, // 10: h2pcontrol.Manager.GetStub:output_type -> h2pcontrol.StubResponse
	5,  // 11: h2pcontrol.Manager.RegisterServer:output_type -> h2pcontrol.RegisterResponse
	0,  // 12: h2pcontrol.Manager.UnregisterServer:output_type -> h2pcontrol.Empty
	2,  // 13: h2pcontrol.Manager.Heartbeat:output_type -> h2pcontrol.HeartbeatPong
	8,  // 14: h2pcontrol.Manager.FetchServers:output_type -> h2pcontrol.FetchServersResponse
	10, // 15: h2pcontrol.Manager.FetchSpecificServer:output_type -> h2pcontrol.FetchSpecificServerResponse
